...
{
    public class ChecklistTypeServiceOld : IChecklistTypeServiceOld
    {
        private readonly ChecklistTypeRepositoryOld _checklistTypeRepository;

        public ChecklistTypeServiceOld()
        {
